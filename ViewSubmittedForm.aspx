...
<form id="form1" runat="server">
    ...
    <div id="editRequestFormMainData">
        ...
        <p>
            <asp:label id="employeeLabel" runat="server" text="Employee: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="initialsLabel" runat="server" text="Initials: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="useridLabel" runat="server" text="UserID: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
        ...
        <p>
            <br />
            <asp:label id="ecompanyLabel" runat="server" text="Employee Company: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="departmentLabel" runat="server" text="Department: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="worklocationLabel" runat="server" text="Work Location: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="workphoneLabel" runat="server" text="Work Phone: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
        ...
        <p>
            <br />
            <asp:label id="emanagerLabel" runat="server" text="Employee Manager: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="mworklocationLabel" runat="server" text="Manager Work Location: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="mworkphoneLabel" runat="server" text="Manager Work Phone: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="reasonforrequestLabel" runat="server" text="Reason for Request: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
        ...
        <p>
            <br />
            <asp:label id="ssnLabel" runat="server" text="SSN: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="getdateLabel" runat="server" text="G.E.T. Date: " font-size="22px" font-bold="True" forecolor="White"></asp:label>
            ...
            <br />
            <asp:label id="dateofbirthLabel" runat="server" text="Date of Birth: " font-size="22px" font-bold="True" forecolor="White"></asp:label>

    ...
    <form id="form1" runat="server">
        ...
        <div id="listboxFormPanel">
            ...
            <p>
                ...
                <asp:ListBox ID="ListBox1" runat="server" DataSourceID="SqlDataSource1" DataTextField="empNAME" DataValueField="uid" BackColor="#CCCCCC" Font-Bold="True" ForeColor="Black" Height="323px" Width="369px" Font-Size="X-Large"></asp:ListBox>

...
<body bgcolor="aliceblue">
    ...
    <div class="jumbotron feature">
		<div class="container">
			<h1><span class="glyphicon glyphicon-equalizer"></span> Approved Forms</h1>
    ...
    <center>
        <asp:ListBox ID="ListBox1" runat="server" DataSourceID="SqlDataSource1" DataTextField="PendingDisplay" DataValueField="RequestID" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" Height="150px" Font-Size="20px" ForeColor="Black"></asp:ListBox>
        ...
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Back" OnClick="Button1_Click"  Width="100px" Font-Bold="true" ForeColor="Black"/>
    </center>
    </div>
    </form>
            </div></div>
